...
const Course=required("../models/Course.model");
...
const deleteCourse=asyncHandler(async(req,res)=>{
    const course = await Course.findById(req.parems.id);
    ...
    res.status.deleteOne();

});

const addLesson=asyncHandle(async(res,req)=>{
